...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
          ...
          new HtmlWebpackPlugin({ 
            filename: 'digital-print.html',
            template: './src/template/digital-print.html',
            inject: 'body',
            chunks: ['subpages', 'calculateDp'],
          }),
          new HtmlWebpackPlugin({  
            filename: 'large-format.html',
            template: './src/template/large-format.html',
            inject: 'body',
            chunks: ['subpages', 'calculateLf'],
          }),
          new HtmlWebpackPlugin({  
            filename: 'exhibition-systems.html',
            template: './src/template/exhibition-systems.html',
            inject: 'body',
            chunks: ['subpages', 'calculateEs'],
          }),
          new HtmlWebpackPlugin({  
            filename: 'spatial-forms.html',
            template: './src/template/spatial-forms.html',
            inject: 'body',
